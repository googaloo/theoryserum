...
<?php if($comments): ?>  
	...
	<h4><?php comments_number('0','1','%'); ?> Comments</h4>
	<ul>
    <?php foreach ($comments as $comment) : ?>  
    	<li class="comments-item" id="comment-<?php comment_id(); ?>">
	        <?php if ($comment->comment_approved == '0') : ?>  
	        	<p>Your comment is waiting for approval</p>
	        <?php endif; ?>  
	        <?php echo get_avatar(get_comment_author_email()); ?>
	        <h4 class="comment-author"><a href="<?php comment_author_link(); ?>"><?php comment_author(); ?></a></h4>
